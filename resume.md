...
* Желаемая должность:  **Ведущий разработчик**
* Занятость: **Любая**
* Каръерный рост: **Желателен**
* Языки: **Украинский, Русский, Английский, Испанский**
* Опыт работы в ИТ сфере более **20 лет**
...
### Проекты для банковской структуры : 
...
* База данных : NOSQL **RethinkDb 2.3.5 (115 GB);**
* Язык разработки : **GO 1.7.3;**
* 150 – **API Handlers;**
* Срок работы в производстве: **более 2 лет**;
* Web Interface **(Admin Panel);**
* Локация – **Украина**;
* Степень нагрузки на сервис : **HeightLoad (24Х7)**;
* Фрейморки и патерны : **Bootstrup, Angular, **;
* Формат : **JSON;**
